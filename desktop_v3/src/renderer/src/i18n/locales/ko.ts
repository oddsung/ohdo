...
export const ko = {
  ...
  about: {
    title: "ohdo 정보",
    tagline: "AI 네이티브 Windows RPA — 대화로 만드는 순수 Python 자동화",
    appVersion: "앱 버전",
    bridgeVersion: "Python 브리지",
    runtime: "런타임",
    checkUpdates: "업데이트 확인",
    latest: "최신 버전을 사용 중입니다.",
    available: "새 버전 v{{version}} 다운로드 중 — 완료되면 하단에 알림이 표시됩니다.",
    devMode: "개발 모드에서는 업데이트 확인을 사용할 수 없습니다.",
    checkError: "업데이트 확인 실패: {{message}}",
    github: "GitHub",
  },
  updater: {
