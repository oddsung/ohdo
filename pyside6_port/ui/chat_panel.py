...
class ChatPanel(QWidget):
    ...
    message_sent = Signal(str)          # 사용자 메시지 전송 시그널
    capture_requested = Signal()        # 화면 캡처 요청 시그널
    element_pick_requested = Signal()   # UI 요소 선택 요청 시그널
    cancel_requested = Signal()         # AI 생성 중지 요청 시그널
